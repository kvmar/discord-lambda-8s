...
def register(inter: Interaction, venmo_user: str) -> None:
  ...
  embed = Embedding("Kali 8s Bot", f"Sent registration fee 8s user {inter.username} with venmo: {venmo_user} payment id: {payment_id} :smiley:. Please accept Venmo request to complete registration", color=0x00FF00)

...
def balance(inter: Interaction) -> None:
  ...
  embed = Embedding("Kali 8s Bot", f"{player_record.player_name} has a balance of ${player_bank_record.credits} with total earnings of ${player_bank_record.earnings}.{deposit_on_hold} :smiley:", color=0x00FF00)
  inter.send_response(embeds=[embed], ephemeral=False)

...
class LeaderboardDao:
  ...
  def get_leaderboard_record_attributes(self, response):
    return LeaderboardRecord(guild_id=response["guild_id"], leaderboard_channel_id=response["leaderboard_channel_id"], leaderboard_message_id=response["leaderboard_message_id"])
